                        ...
                        if (this.ItemColumns[C] == "Price") {
                            ...
                            if (this.ItemColumns[C] == "Options" && this.options()) {
                                ...
                                if (this.ItemColumns[C] == "Quantity") {
                                    tempCell.innerHTML = '<input type="text" width="10%" onblur="simpleCart.updateQuantity(' + tempItem.functionString() + ",'new_quantity=' + this.value);return false;\"value=\"" + tempItem.getValue("quantity") + '" />'
                                } else {
